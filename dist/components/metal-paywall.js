...
export class MetalPaywall extends Component {
    constructor() {
        super(...arguments);
        this.loadingMessage = "loading supporter panel";
        this.onMakeUserPremium = this.model.makeUserPremium;
        this.onRevokeUserPremium = this.model.revokeUserPremium;
    }
    static get styles() { return [super.styles || css ``, styles]; }
    updated() {
        if (!this.model)
            throw new Error("paywall panel requires model");
