import { User, Profile, AuthTokens, AccessToken, TokenStorageTopic, VimeoGovernorTopic, PaywallGuardianTopic, ProfileMagistrateTopic } from "authoritarian/dist/interfaces.js";
...
export declare type AccountPopupLogin = (authServerUrl: string) => Promise<AuthTokens>;
export declare type LoginPopupRoutine = () => Promise<AuthTokens>;
...
export declare type UserUpdate = (state: UserState) => void;
export declare type UserReader = Reader<UserState>;
