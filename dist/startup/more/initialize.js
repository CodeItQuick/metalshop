import { createTokenStorageClient } from "authoritarian/dist/clients/create-token-storage-client.js";
import { createProfileMagistrateClient } from "authoritarian/dist/clients/create-profile-magistrate-client.js";
import { triggerLoginPopup } from "authoritarian/dist/account-popup/trigger-login-popup.js";
...
export async function initialize(config) {
    ...
    //
    if (config.mock !== null) {
        const { prepareAllMocks, getMockTokens } = await import("../../system/mocks.js");
        const { tokenStorage, vimeoGovernor, scheduleSentry, paywallGuardian, questionsBureau, loginPopupRoutine, profileMagistrate, } = prepareAllMocks({
